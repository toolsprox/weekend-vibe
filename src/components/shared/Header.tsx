      ...
      <div className="max-w-7xl mx-auto rounded-full bg-transparent">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <nav className="flex items-center gap-8 z-50">
            <a href="#reserve" className="px-6 py-2.5 rounded-full bg-cyan-400 text-black text-sm font-bold uppercase tracking-widest hover:bg-fuchsia-500 hover:text-white transition-all shadow-[0_4px_14px_rgba(34,211,238,0.3)] hover:shadow-[0_4px_20px_rgba(217,70,239,0.5)]">Book Table</a>
          </nav>
        </div>
      </div>
    </header>
